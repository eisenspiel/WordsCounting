...
namespace WordsCounting
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (path == "")
            {
                path = @"D:\Vojnaimir.Tom1.UTF8.txt";
            }
            ...
            if (ChosenMethod == "1")
            {
                ...
                var magicMethod = WordsCountIstance.GetType().GetMethod("CountWords", BindingFlags.NonPublic | BindingFlags.Static);
            ...
            else
            {
                ...
                wordCount = WordsCountingClass.CountWordsMultithread(whole_text);
            }
